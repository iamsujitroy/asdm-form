...
const TableContainer = ({ columns, data, value, setValue }) => {
                    ...
                    {headerGroups.map(headerGroup => (
                        <>
                            <tr {...headerGroup.getHeaderGroupProps()}>
                                ...
                                <th>Edit<br /><input className="form-control" disabled></input></th>
                            </tr>
                            {/* <tr {...headerGroup.getHeaderGroupProps()}>
                            {headerGroup.headers.map(column => (
                    ...
                    {page.map((row, i) => {
                        ...
                        return (
                            <tr {...row.getRowProps()}>
                                ...
                                <td>
                                    <button onClick={handleChange} value={row.id} className="submit-btn-sm">Edit</button>
                                </td>
                            </tr>
                        )
                    })}
